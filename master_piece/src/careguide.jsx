      ...
      <div className="max-w-6xl mx-auto bg-white rounded-lg shadow-xl overflow-hidden">
        ...
        <div className="p-6">
          <div className="mb-6 flex">
            ...
            <button
              onClick={addPlant}
              className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-r-lg transition duration-300 ease-in-out"
            >
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg border border-green-200">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <button className="w-full bg-green-500 hover:bg-green-600 text-white p-3 rounded-lg transition duration-300 ease-in-out">
